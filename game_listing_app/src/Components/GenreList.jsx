...
export default function GenreList({ genreId, onSelectGenre }) {
    ...
    <div className=" pr-6">
      ...
      {genreList.map((item, index) => (
        <div
          ...
          key={item.id}
          className={`flex gap-2 items-center mb-2 cursor-pointer hover:bg-gray-300 p-2 rounded-lg hover:dark:bg-gray-600
           group ${
